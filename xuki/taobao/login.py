...
# @File : login.py
# @Annotation : 
# https://www.cnblogs.com/xingkongzhizhu/p/11632531.html
import re
import os
import json
...
if __name__ == '__main__':
    ...
    loginId = 'tb8159_1971'
    # 改版后增加的参数，后面考虑解密这个参数
    umidToken = '9838e929fe6940e1f4a4b548efd39e20fad95455',
    # 淘宝重要参数，从浏览器或抓包工具中复制，可重复使用
    ua = '139#'
    # 加密后的密码，从浏览器或抓包工具中复制，可重复使用
    password2 = ''
